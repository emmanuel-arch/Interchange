...
const PROTECTED = ["/directory", "/exposure", "/consent", "/audit", "/score", "/learning", "/log"];
...
export const config = {
  matcher: ["/directory/:path*", "/exposure/:path*", "/consent/:path*", "/audit/:path*", "/score/:path*", "/learning/:path*", "/log/:path*"],
};
